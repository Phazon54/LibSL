...
typedef void (APIENTRYP PFNGLUXSETINVARIANTEXTPROC) (GLuint id, GLenum type, const void *addr);
#endif
#ifndef __GLUX__GLFCT_glSetLocalConstantEXT
typedef void (APIENTRYP PFNGLUXSETLOCALCONSTANTEXTPROC) (GLuint id, GLenum type, const void *addr);
#endif
...
typedef void (APIENTRYP PFNGLUXVARIANTPOINTEREXTPROC) (GLuint id, GLenum type, GLuint stride, const void *addr);
#endif
...
typedef void (APIENTRYP PFNGLUXGETVARIANTPOINTERVEXTPROC) (GLuint id, GLenum value, void **data);
#endif
