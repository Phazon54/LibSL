...
typedef void (APIENTRYP PFNGLUXMULTIDRAWELEMENTSPROC) (GLenum mode, const GLsizei *count, GLenum type, const void *const*indices, GLsizei drawcount);
#endif
...
typedef void (APIENTRYP PFNGLUXFOGCOORDPOINTERPROC) (GLenum type, GLsizei stride, const void *pointer);
#endif
...
typedef void (APIENTRYP PFNGLUXSECONDARYCOLORPOINTERPROC) (GLint size, GLenum type, GLsizei stride, const void *pointer);
#endif
