...
typedef void (APIENTRYP PFNGLUXBUFFERDATAARBPROC) (GLenum target, GLsizeiptrARB size, const void *data, GLenum usage);
#endif
#ifndef __GLUX__GLFCT_glBufferSubDataARB
typedef void (APIENTRYP PFNGLUXBUFFERSUBDATAARBPROC) (GLenum target, GLintptrARB offset, GLsizeiptrARB size, const void *data);
#endif
#ifndef __GLUX__GLFCT_glGetBufferSubDataARB
typedef void (APIENTRYP PFNGLUXGETBUFFERSUBDATAARBPROC) (GLenum target, GLintptrARB offset, GLsizeiptrARB size, void *data);
#endif
#ifndef __GLUX__GLFCT_glMapBufferARB
typedef void *(APIENTRYP PFNGLUXMAPBUFFERARBPROC) (GLenum target, GLenum access);
#endif
...
typedef void (APIENTRYP PFNGLUXGETBUFFERPOINTERVARBPROC) (GLenum target, GLenum pname, void **params);
#endif
// --------------------------------------------------------
