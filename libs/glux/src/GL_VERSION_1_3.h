...
typedef void (APIENTRYP PFNGLUXCOMPRESSEDTEXIMAGE3DPROC) (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void *data);
#endif
#ifndef __GLUX__GLFCT_glCompressedTexImage2D
typedef void (APIENTRYP PFNGLUXCOMPRESSEDTEXIMAGE2DPROC) (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void *data);
#endif
#ifndef __GLUX__GLFCT_glCompressedTexImage1D
typedef void (APIENTRYP PFNGLUXCOMPRESSEDTEXIMAGE1DPROC) (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void *data);
#endif
#ifndef __GLUX__GLFCT_glCompressedTexSubImage3D
typedef void (APIENTRYP PFNGLUXCOMPRESSEDTEXSUBIMAGE3DPROC) (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void *data);
#endif
#ifndef __GLUX__GLFCT_glCompressedTexSubImage2D
typedef void (APIENTRYP PFNGLUXCOMPRESSEDTEXSUBIMAGE2DPROC) (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void *data);
#endif
#ifndef __GLUX__GLFCT_glCompressedTexSubImage1D
typedef void (APIENTRYP PFNGLUXCOMPRESSEDTEXSUBIMAGE1DPROC) (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void *data);
#endif
#ifndef __GLUX__GLFCT_glGetCompressedTexImage
typedef void (APIENTRYP PFNGLUXGETCOMPRESSEDTEXIMAGEPROC) (GLenum target, GLint level, void *img);
#endif
