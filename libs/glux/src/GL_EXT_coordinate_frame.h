...
typedef void (APIENTRYP PFNGLUXTANGENTPOINTEREXTPROC) (GLenum type, GLsizei stride, const void *pointer);
#endif
#ifndef __GLUX__GLFCT_glBinormalPointerEXT
typedef void (APIENTRYP PFNGLUXBINORMALPOINTEREXTPROC) (GLenum type, GLsizei stride, const void *pointer);
#endif
// --------------------------------------------------------
