...
typedef void (APIENTRYP PFNGLUXPATHCOMMANDSNVPROC) (GLuint path, GLsizei numCommands, const GLubyte *commands, GLsizei numCoords, GLenum coordType, const void *coords);
#endif
#ifndef __GLUX__GLFCT_glPathCoordsNV
typedef void (APIENTRYP PFNGLUXPATHCOORDSNVPROC) (GLuint path, GLsizei numCoords, GLenum coordType, const void *coords);
#endif
#ifndef __GLUX__GLFCT_glPathSubCommandsNV
typedef void (APIENTRYP PFNGLUXPATHSUBCOMMANDSNVPROC) (GLuint path, GLsizei commandStart, GLsizei commandsToDelete, GLsizei numCommands, const GLubyte *commands, GLsizei numCoords, GLenum coordType, const void *coords);
#endif
#ifndef __GLUX__GLFCT_glPathSubCoordsNV
typedef void (APIENTRYP PFNGLUXPATHSUBCOORDSNVPROC) (GLuint path, GLsizei coordStart, GLsizei numCoords, GLenum coordType, const void *coords);
#endif
#ifndef __GLUX__GLFCT_glPathStringNV
typedef void (APIENTRYP PFNGLUXPATHSTRINGNVPROC) (GLuint path, GLenum format, GLsizei length, const void *pathString);
#endif
#ifndef __GLUX__GLFCT_glPathGlyphsNV
typedef void (APIENTRYP PFNGLUXPATHGLYPHSNVPROC) (GLuint firstPathName, GLenum fontTarget, const void *fontName, GLbitfield fontStyle, GLsizei numGlyphs, GLenum type, const void *charcodes, GLenum handleMissingGlyphs, GLuint pathParameterTemplate, GLfloat emScale);
#endif
#ifndef __GLUX__GLFCT_glPathGlyphRangeNV
typedef void (APIENTRYP PFNGLUXPATHGLYPHRANGENVPROC) (GLuint firstPathName, GLenum fontTarget, const void *fontName, GLbitfield fontStyle, GLuint firstGlyph, GLsizei numGlyphs, GLenum handleMissingGlyphs, GLuint pathParameterTemplate, GLfloat emScale);
#endif
...
typedef void (APIENTRYP PFNGLUXSTENCILFILLPATHINSTANCEDNVPROC) (GLsizei numPaths, GLenum pathNameType, const void *paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum transformType, const GLfloat *transformValues);
#endif
#ifndef __GLUX__GLFCT_glStencilStrokePathInstancedNV
typedef void (APIENTRYP PFNGLUXSTENCILSTROKEPATHINSTANCEDNVPROC) (GLsizei numPaths, GLenum pathNameType, const void *paths, GLuint pathBase, GLint reference, GLuint mask, GLenum transformType, const GLfloat *transformValues);
#endif
...
typedef void (APIENTRYP PFNGLUXCOVERFILLPATHINSTANCEDNVPROC) (GLsizei numPaths, GLenum pathNameType, const void *paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat *transformValues);
#endif
#ifndef __GLUX__GLFCT_glCoverStrokePathInstancedNV
typedef void (APIENTRYP PFNGLUXCOVERSTROKEPATHINSTANCEDNVPROC) (GLsizei numPaths, GLenum pathNameType, const void *paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat *transformValues);
#endif
...
typedef void (APIENTRYP PFNGLUXGETPATHMETRICSNVPROC) (GLbitfield metricQueryMask, GLsizei numPaths, GLenum pathNameType, const void *paths, GLuint pathBase, GLsizei stride, GLfloat *metrics);
#endif
...
typedef void (APIENTRYP PFNGLUXGETPATHSPACINGNVPROC) (GLenum pathListMode, GLsizei numPaths, GLenum pathNameType, const void *paths, GLuint pathBase, GLfloat advanceScale, GLfloat kerningScale, GLenum transformType, GLfloat *returnedSpacing);
#endif
...
#endif
#ifndef __GLUX__GLFCT_glMatrixLoad3x2fNV
typedef void (APIENTRYP PFNGLUXMATRIXLOAD3X2FNVPROC) (GLenum matrixMode, const GLfloat *m);
#endif
#ifndef __GLUX__GLFCT_glMatrixLoad3x3fNV
typedef void (APIENTRYP PFNGLUXMATRIXLOAD3X3FNVPROC) (GLenum matrixMode, const GLfloat *m);
#endif
#ifndef __GLUX__GLFCT_glMatrixLoadTranspose3x3fNV
typedef void (APIENTRYP PFNGLUXMATRIXLOADTRANSPOSE3X3FNVPROC) (GLenum matrixMode, const GLfloat *m);
#endif
#ifndef __GLUX__GLFCT_glMatrixMult3x2fNV
typedef void (APIENTRYP PFNGLUXMATRIXMULT3X2FNVPROC) (GLenum matrixMode, const GLfloat *m);
#endif
#ifndef __GLUX__GLFCT_glMatrixMult3x3fNV
typedef void (APIENTRYP PFNGLUXMATRIXMULT3X3FNVPROC) (GLenum matrixMode, const GLfloat *m);
#endif
#ifndef __GLUX__GLFCT_glMatrixMultTranspose3x3fNV
typedef void (APIENTRYP PFNGLUXMATRIXMULTTRANSPOSE3X3FNVPROC) (GLenum matrixMode, const GLfloat *m);
#endif
#ifndef __GLUX__GLFCT_glStencilThenCoverFillPathNV
typedef void (APIENTRYP PFNGLUXSTENCILTHENCOVERFILLPATHNVPROC) (GLuint path, GLenum fillMode, GLuint mask, GLenum coverMode);
#endif
#ifndef __GLUX__GLFCT_glStencilThenCoverStrokePathNV
typedef void (APIENTRYP PFNGLUXSTENCILTHENCOVERSTROKEPATHNVPROC) (GLuint path, GLint reference, GLuint mask, GLenum coverMode);
#endif
#ifndef __GLUX__GLFCT_glStencilThenCoverFillPathInstancedNV
typedef void (APIENTRYP PFNGLUXSTENCILTHENCOVERFILLPATHINSTANCEDNVPROC) (GLsizei numPaths, GLenum pathNameType, const void *paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat *transformValues);
#endif
#ifndef __GLUX__GLFCT_glStencilThenCoverStrokePathInstancedNV
typedef void (APIENTRYP PFNGLUXSTENCILTHENCOVERSTROKEPATHINSTANCEDNVPROC) (GLsizei numPaths, GLenum pathNameType, const void *paths, GLuint pathBase, GLint reference, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat *transformValues);
#endif
#ifndef __GLUX__GLFCT_glPathGlyphIndexRangeNV
typedef GLenum (APIENTRYP PFNGLUXPATHGLYPHINDEXRANGENVPROC) (GLenum fontTarget, const void *fontName, GLbitfield fontStyle, GLuint pathParameterTemplate, GLfloat emScale, GLuint baseAndCount[2]);
#endif
#ifndef __GLUX__GLFCT_glPathGlyphIndexArrayNV
typedef GLenum (APIENTRYP PFNGLUXPATHGLYPHINDEXARRAYNVPROC) (GLuint firstPathName, GLenum fontTarget, const void *fontName, GLbitfield fontStyle, GLuint firstGlyphIndex, GLsizei numGlyphs, GLuint pathParameterTemplate, GLfloat emScale);
#endif
#ifndef __GLUX__GLFCT_glPathMemoryGlyphIndexArrayNV
typedef GLenum (APIENTRYP PFNGLUXPATHMEMORYGLYPHINDEXARRAYNVPROC) (GLuint firstPathName, GLenum fontTarget, GLsizeiptr fontSize, const void *fontData, GLsizei faceIndex, GLuint firstGlyphIndex, GLsizei numGlyphs, GLuint pathParameterTemplate, GLfloat emScale);
#endif
#ifndef __GLUX__GLFCT_glProgramPathFragmentInputGenNV
typedef void (APIENTRYP PFNGLUXPROGRAMPATHFRAGMENTINPUTGENNVPROC) (GLuint program, GLint location, GLenum genMode, GLint components, const GLfloat *coeffs);
#endif
#ifndef __GLUX__GLFCT_glGetProgramResourcefvNV
typedef void (APIENTRYP PFNGLUXGETPROGRAMRESOURCEFVNVPROC) (GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum *props, GLsizei bufSize, GLsizei *length, GLfloat *params);
#endif
...
#endif
#ifndef __GLUX__GLFCT_glMatrixLoad3x2fNV
extern PFNGLUXMATRIXLOAD3X2FNVPROC glMatrixLoad3x2fNV;
#endif
#ifndef __GLUX__GLFCT_glMatrixLoad3x3fNV
extern PFNGLUXMATRIXLOAD3X3FNVPROC glMatrixLoad3x3fNV;
#endif
#ifndef __GLUX__GLFCT_glMatrixLoadTranspose3x3fNV
extern PFNGLUXMATRIXLOADTRANSPOSE3X3FNVPROC glMatrixLoadTranspose3x3fNV;
#endif
#ifndef __GLUX__GLFCT_glMatrixMult3x2fNV
extern PFNGLUXMATRIXMULT3X2FNVPROC glMatrixMult3x2fNV;
#endif
#ifndef __GLUX__GLFCT_glMatrixMult3x3fNV
extern PFNGLUXMATRIXMULT3X3FNVPROC glMatrixMult3x3fNV;
#endif
#ifndef __GLUX__GLFCT_glMatrixMultTranspose3x3fNV
extern PFNGLUXMATRIXMULTTRANSPOSE3X3FNVPROC glMatrixMultTranspose3x3fNV;
#endif
#ifndef __GLUX__GLFCT_glStencilThenCoverFillPathNV
extern PFNGLUXSTENCILTHENCOVERFILLPATHNVPROC glStencilThenCoverFillPathNV;
#endif
#ifndef __GLUX__GLFCT_glStencilThenCoverStrokePathNV
extern PFNGLUXSTENCILTHENCOVERSTROKEPATHNVPROC glStencilThenCoverStrokePathNV;
#endif
#ifndef __GLUX__GLFCT_glStencilThenCoverFillPathInstancedNV
extern PFNGLUXSTENCILTHENCOVERFILLPATHINSTANCEDNVPROC glStencilThenCoverFillPathInstancedNV;
#endif
#ifndef __GLUX__GLFCT_glStencilThenCoverStrokePathInstancedNV
extern PFNGLUXSTENCILTHENCOVERSTROKEPATHINSTANCEDNVPROC glStencilThenCoverStrokePathInstancedNV;
#endif
#ifndef __GLUX__GLFCT_glPathGlyphIndexRangeNV
extern PFNGLUXPATHGLYPHINDEXRANGENVPROC glPathGlyphIndexRangeNV;
#endif
#ifndef __GLUX__GLFCT_glPathGlyphIndexArrayNV
extern PFNGLUXPATHGLYPHINDEXARRAYNVPROC glPathGlyphIndexArrayNV;
#endif
#ifndef __GLUX__GLFCT_glPathMemoryGlyphIndexArrayNV
extern PFNGLUXPATHMEMORYGLYPHINDEXARRAYNVPROC glPathMemoryGlyphIndexArrayNV;
#endif
#ifndef __GLUX__GLFCT_glProgramPathFragmentInputGenNV
extern PFNGLUXPROGRAMPATHFRAGMENTINPUTGENNVPROC glProgramPathFragmentInputGenNV;
#endif
#ifndef __GLUX__GLFCT_glGetProgramResourcefvNV
extern PFNGLUXGETPROGRAMRESOURCEFVNVPROC glGetProgramResourcefvNV;
#endif
#ifndef __GLUX__GLFCT_glPathColorGenNV
