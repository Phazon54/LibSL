...
typedef void (APIENTRYP PFNGLUXGETATTACHEDSHADERSPROC) (GLuint program, GLsizei maxCount, GLsizei *count, GLuint *shaders);
#endif
...
typedef void (APIENTRYP PFNGLUXGETVERTEXATTRIBPOINTERVPROC) (GLuint index, GLenum pname, void **pointer);
#endif
...
typedef void (APIENTRYP PFNGLUXVERTEXATTRIBPOINTERPROC) (GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const void *pointer);
#endif
// --------------------------------------------------------
