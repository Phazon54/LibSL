...
typedef void (APIENTRYP PFNGLUXMULTIDRAWARRAYSEXTPROC) (GLenum mode, const GLint *first, const GLsizei *count, GLsizei primcount);
#endif
#ifndef __GLUX__GLFCT_glMultiDrawElementsEXT
typedef void (APIENTRYP PFNGLUXMULTIDRAWELEMENTSEXTPROC) (GLenum mode, const GLsizei *count, GLenum type, const void *const*indices, GLsizei primcount);
#endif
// --------------------------------------------------------
